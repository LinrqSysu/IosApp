...
- (id) initWithHeight: (CGFloat) viewHeight;
{
    ...
    PhotoFallViewController *photoFallController = [[PhotoFallViewController alloc] init];
    ...
    photoFallController.viewHeight = viewHeight;
    
    PhotoWallViewController *photoWallController = [[PhotoWallViewController alloc] init];
    ...
    photoWallController.viewHeight = viewHeight;
    
    self.viewControllers = [NSArray arrayWithObjects: photoFallController, photoWallController, nil];
